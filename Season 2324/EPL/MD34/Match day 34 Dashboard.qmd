...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 34/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 34/Viz Pack/")

#set oppo
Match_Oppo <- paste("Everton")

#set oppo color
Color_Oppo <- paste("#0035b8")
...
MatchIdUS <- 22179 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193815 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/971e0a29/Merseyside-Derby-Everton-Liverpool-April-24-2024-Premier-League") #check

#set Game name
GameName <- paste("EFC_vs_LFC")
...
GameNamePlayers <- paste("EFC_vs_LFC_players")
