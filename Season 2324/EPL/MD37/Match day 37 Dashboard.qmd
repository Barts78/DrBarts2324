...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 37/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 37/Viz Pack/")

#set oppo
Match_Oppo <- paste("Aston Villa")

#set oppo color
Color_Oppo <- paste("#7D1142")
...
MatchIdUS <- 22256 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193892 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/72c0709d/Aston-Villa-Liverpool-May-13-2024-Premier-League") #check

#set Game name
GameName <- paste("AVFC_vs_LFC")
...
GameNamePlayers <- paste("AVFC_vs_LFC_players")
