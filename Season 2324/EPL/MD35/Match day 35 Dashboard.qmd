...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 35/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 35/Viz Pack/")

#set oppo
Match_Oppo <- paste("West Ham United")

#set oppo color
Color_Oppo <- paste("#7B2B3A")
...
MatchIdUS <- 22243 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193879 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/ba04d7d8/West-Ham-United-Liverpool-April-27-2024-Premier-League") #check

#set Game name
GameName <- paste("WHUFC_vs_LFC")
...
GameNamePlayers <- paste("WHUFC_vs_LFC_players")
