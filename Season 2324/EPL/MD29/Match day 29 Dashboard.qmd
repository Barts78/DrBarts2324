...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 29/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 29/Viz Pack/")

#set Away
Match_Oppo <- paste("Brighton & Hove Albion")

#set Away color
Color_Oppo <- paste("#0850A0")
...
MatchIdUS <- 22189 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193825 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/b763b73e/Liverpool-Brighton-and-Hove-Albion-March-31-2024-Premier-League") #check

#set Game name
GameName <- paste("LFC_vs_BHAFC")
...
GameNamePlayers <- paste("LFC_vs_BHAFC_players")
