...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 30/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 30/Viz Pack/")

#set Away
Match_Oppo <- paste("Sheffield United")

#set Away color
Color_Oppo <- paste("#FFFF00")

#set Away text
Color_Oppo_Text <- paste("black")

#set away color scale
ColorScale_Away <- paste("ggsci::yellow_material")

#set away color scale con
ColorScale_AwayC <- paste("ggthemes::Classic Orange")
...
MatchIdUS <- 22203 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193839 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/1f5973e2/Liverpool-Sheffield-United-April-4-2024-Premier-League") #check

#set Game name
GameName <- paste("LFC_vs_SHUFC")
...
GameNamePlayers <- paste("LFC_vs_SHUFC_players")
