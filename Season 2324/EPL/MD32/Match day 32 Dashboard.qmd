...
#set oppo
Match_Oppo <- paste("Crystal Palace")

#set oppo color
Color_Oppo <- paste("#0055A5")

#set oppo text
Color_Oppo_Text <- paste("ivory")
...
MatchIdUS <- 22220 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193856 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/99113ef3/Liverpool-Crystal-Palace-April-14-2024-Premier-League") #check

#set Game name
GameName <- paste("LFC_vs_CPFC")
...
GameNamePlayers <- paste("LFC_vs_CPFC_players")
