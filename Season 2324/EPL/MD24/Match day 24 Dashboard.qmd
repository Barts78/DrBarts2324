...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Match day 24/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Match day 24/Viz Pack/")

#set oppo
Match_Oppo <- paste("Burnley")

#set oppo colors
Color_Oppo <- paste("yellow")

Color_Oppo_Text <- paste("purple4")

#Set LFC
Match_LFC <- paste("Liverpool")

#set Home color
Color_LFC <- paste("firebrick")

Color_LFC_Text <- paste("white")
...
ColorScale_AwayC <- paste("grDevices::YlGnBu")

#set match date
Game_date <- paste("10-02-24")
...
#set fixture
Match_Fixture <- paste0(Match_LFC, " vs ", Match_Oppo, " (h) ", Game_date)

#set dashboard fixture
Match_Fixture_Dash <- paste0(Match_LFC, " vs ", Match_Oppo, " (h) ", Game_date)

#set  UnderStat match ID
MatchIdUS <- 22128 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193764 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/29e4d6ac/Liverpool-Burnley-February-10-2024-Premier-League") #check

#set Game name
GameName <- paste("LFC_vs_BFC")

GameWeek <- paste("MD24")

#set Game name PLayers
GameNamePlayers <- paste("LFC_vs_BFC_players")
...
#set Shot titles
ShotTitle_text_Home <- paste0(
  ' Shot Map - Result & xG (', 
  '<span style="color:firebrick">Goal </span>',
  'and',
  '<span style="color:#95A5A6"> No Goal</span>','), ')

ShotTitle_text_Away <- paste0(
  ' Shot Map - Result & xG (', 
  ...
  '<span style="color:#95A5A6"> No Goal</span>','), ')
    ...
    #set title
#AwayteamColor = Color_Oppo

#set shot title away
#ShotTitle_text_Away <- paste0(glue("<span style='font-family:\"Arial\";color:black;font-size:16px;'>Shot Map (</span><span style='font-family:\"Arial Bold\";color:yellow2;font-size:16px;'>Goal</span><span style='font-family:\"Arial\";color:black;font-size:16px;'> and </span><span style='font-family:\"Arial Bold\";color:#95A5A6;font-size:16px;'>No Goal</span><span style='color:black;font-size:16px;'>)</span>"))
...
HomeFieldTilt <- round((((sum(plottingData$Final_Third_Touches == 1 & plottingData$teamId == Match_LFC))/Final_Third_Possession)*100),2)
OppoFieldTilt <- round((((sum(plottingData$Final_Third_Touches == 1 & plottingData$teamId == Match_Oppo))/Final_Third_Possession)*100),2)
...
FieldTiltTable <- data.frame(
  teamId = c(Match_LFC, Match_Oppo),
 Field_Tilt = c(HomeFieldTilt, OppoFieldTilt))
...
#  filter(match_id == MatchIdUS & away_team == Match_LFC & home_away == "a")
  filter(match_id == MatchIdUS & home_team == Match_LFC & home_away == "h")
...
#  filter(match_id == MatchIdUS & home_team == Match_Oppo & home_away == "h")
  filter(match_id == MatchIdUS & away_team == Match_Oppo & home_away == "a")
...
#            style = cell_text(align = "right")) %>%
    tab_style(
    style = list(cell_text(weight = "bold", color = Color_LFC_Text), cell_fill(color = Color_LFC)),
...
lineupdataAway <- lineupdata %>%
  ...
  cols_width(col = c(5:8) ~ px(50)) %>%
    tab_style(
    style = list(cell_text(weight = "bold", color = Color_Oppo_Text), cell_fill(color = Color_Oppo)),
    locations = cells_row_groups(groups = everything())) %>%
  tab_style(
    locations = cells_title(groups = "title"),
    style = list(cell_text(weight = "bold", size = 16))) %>%
...
MatchSummaryPeriodTable <- MatchSummaryPeriodData %>%
  ...
  tab_style(
    ...
    style = list(cell_fill(color = Color_Oppo),
                 cell_text(size = 16, weight = "bold", color = Color_Oppo_Text))) %>%
  tab_style(
    locations = cells_stub( rows = c(2, 4, 6, 8, 10, 12, 14)),
    style = list(cell_fill(color = Color_LFC),
                cell_text(size = 16,  weight = "bold", color = Color_LFC_Text))) %>%
  tab_style(
    locations = cells_title(groups = "title"),
    style = list(cell_text(weight = "bold", size = 16))) %>%
  tab_options(
...
LFCpassPlot1stWD <- plot_passnet_AI(data = plottingData,
                                  ...
                                  scale_color = Color_LFC, text_color = Color_LFC_Text, subtitle = paste0(Match_Fixture, " 1st Half"),
...
OppopassPlot1stWD <- plot_passnet_AI(data = plottingData,  
                                   ...
                                   scale_color = Color_Oppo,  text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture, " 1st Half"),
                                   plot_start = 00, plot_finish = 44, pressmap = "Yes", logo = "", passes = 4)
OppopassPlot1stWD
```
...
LFCpassPlot2ndWD <- plot_passnet_AI(data = plottingData,  
                                  team_name = Match_LFC, scale_stat = "EPV", 
                                  scale_color = Color_LFC,  text_color = Color_LFC_Text, subtitle = paste0(Match_Fixture, " 2nd Half"),
...
OppopassPlot2ndWD <- plot_passnet_AI(data = plottingData,  
                                   team_name = Match_Oppo, scale_stat = "EPV", 
                                   scale_color = Color_Oppo, text_color = Color_Oppo_Text,  subtitle = paste0(Match_Fixture, " 2nd Half"),
...
LFCpassPlot1stsubsWD <- plot_passnet_AI(data = plottingData, 
                                   team_name = Match_LFC, scale_stat = "EPV", 
                                   scale_color = Color_LFC, text_color = Color_LFC_Text, subtitle = paste0(Match_Fixture, " To 1st Subs"),
...
OppopassPlot1stsubsWD <- plot_passnet_AI(data = plottingData, 
                                        team_name = Match_Oppo, scale_stat = "EPV", 
                                        scale_color = Color_Oppo,  text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture, " To 1st Subs"),
...
LFCpassPlotWrapWD <- plot_passnet_AI(data = plottingData,  
                                     team_name = Match_LFC, scale_stat = "EPV", 
                                     scale_color = Color_LFC,  text_color = Color_LFC_Text, subtitle = paste0(Match_Fixture),
...
OppopassPlotWrapWD <- plot_passnet_AI(data = plottingData,  
                                      team_name = Match_Oppo, scale_stat = "EPV", 
                                      scale_color = Color_Oppo,  text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture),
                                      plot_start = 00, plot_finish = 100, wrap = "Yes", pressmap = "Yes", passes = 2)
OppopassPlotWrapWD
```
...
LFCpassPlot1subAtt <- plot_passnet_AI(data = plottingData,  
                                    team_name = Match_LFC, scale_stat = "EPV", 
                                    scale_color = Color_LFC,  text_color = Color_LFC_Text, subtitle = paste0(Match_Fixture, " up to 1st Sub"),
...
OppopassPlot1SubAtt <- plot_passnet_AI(data = plottingData,
                                      team_name = Match_Oppo, scale_stat = "EPV", 
                                      scale_color = Color_Oppo,  text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture, " up to 1st Sub"),
...
LFCpassPlotFTAttW <- plot_passnet_AI(data = plottingData,  
                                      team_name = Match_LFC, scale_stat = "EPV", 
                                      scale_color = Color_LFC,  text_color = Color_LFC_Text, subtitle = paste0(Match_Fixture, " By Time Period (Opta data)"),
...
OppopassPlotFTAttW <- plot_passnet_AI(data = plottingData,  
                                     team_name = Match_Oppo, scale_stat = "EPV", 
                                     scale_color = Color_Oppo,  text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture, " By Time Period (Opta data)"),
                                     plot_start = 00, plot_finish = 100, pitch = "Half", pressmap = "Yes", wrap = "Yes", passes = 2)
OppopassPlotFTAttW
```
...
passing_sequencesLFC_Plot <- passing_sequencesLFC %>%
  ...
  theme(plot.title = element_text(colour = "black", face = "bold", size = 14),
        ...
        panel.background = element_blank(),
        legend.position = "none",
        strip.text = element_text(size = 6, colour = Color_LFC_Text),
...
passing_sequencesOppo_Plot <- passing_sequencesOppo %>%
  ...
  theme(plot.title = element_text(colour = "black", face = "bold", size = 14),
        ...
        panel.background = element_blank(),
        legend.position = "none",
        strip.text = element_text(size = 6, colour = Color_Oppo_Text),
...
LFCconvexPlot1stsubs <- TouchPlayerPlot_AI(TouchDataLFC,  title = Match_LFC,
                                    plot_start = 00, plot_finish = firstSub, color = Color_LFC, text_color = Color_LFC_Text,
...
OPPOconvexPlot1stSubs <- TouchPlayerPlot_AI(TouchDataOppo,  title = Match_Oppo,
                                     plot_start = 00, plot_finish = firstSubOppo,  color = Color_Oppo, text_color = Color_Oppo_Text,
                                     subtitle = paste0(Match_Fixture, " Up to 1st subs"))
...
LFCDribblesPlotT <- LFCDribblesmapdata %>%
  ...
  theme(plot.title = element_markdown(),
        ...
        plot.subtitle = element_text(colour = "black", size = 10),
        legend.position = "none",
        strip.text.x = element_text(face = "bold", size = 8, colour = Color_LFC_Text),
...
theme(plot.title = element_markdown(),
      ...
      legend.position = "none",
      strip.text.x = element_text(face = "bold", size = 8, colour = Color_Oppo_Text),
...
Player_Summary_Plot_Home <- Player_Summary_data_Home %>% 
  ...
  theme(plot.subtitle = element_text(colour = "black", size = 8),
        ...
        panel.background = element_rect(colour = "snow", fill = "snow"),
        plot.background = element_rect(fill = "snow", color = "snow"),
        strip.text.x = element_text(size = 4, colour = Color_LFC_Text, face = "bold"),
...
Player_Summary_Plot_Away <- Player_Summary_data_Away %>% 
  ...
  theme(plot.subtitle = element_text(colour = "black", size = 8),
        ...
        panel.background = element_rect(colour = "snow", fill = "snow"),
        plot.background = element_rect(fill = "snow", color = "snow"),
        strip.text.x = element_text(size = 4, colour = Color_Oppo_Text, face = "bold"),
...
EPVMapplotFT <- ggplot(average_epvFT, aes(x = zone_x, y = zone_y, fill = avg_epv)) +
  ...
  #formatting
  labs(title = paste0(Match_LFC," Open Play EPV Heat Map - Full Game"), 
...
EPVHeatMapplotFT <- EPVHeatMapDataFT %>%
  ...
  #geometrics
  #stat_density_2d(aes(color = after_stat(level), fill = after_stat(level), text = paste("EPV: ", after_stat(level))), geom = "polygon", alpha = 0.8, linewidth = 1) +
...
EPVHeatMapplot1sub <- EPVHeatMapData1sub %>%
  ...
  #formatting
  labs(title = paste0(Match_LFC," Open Play EPV Heat Map - Up to first subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
EPVHeatMapplotP1sub <- EPVHeatMapDataP1sub %>%
  ...
  #formatting
  labs(title = paste0(Match_LFC," Open Play EPV Heat Map - Post 1st Subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
EPVHeatMapplot1H <- EPVHeatMapData1H %>%
  ...
  #formatting
  labs(title = paste0(Match_LFC," Open Play EPV Heat Map - First Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
EPVHeatMapplot2H <- EPVHeatMapData2H %>%
  ...
  #formatting
  labs(title = paste0(Match_LFC," Open Play EPV Heat Map - Second Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
OppoEPVHeatMapplot1H <- OppoEPVHeatMapData1H %>%
  ...
  #formatting
  labs(title = paste(Match_Oppo," Open Play EPV Heat Map - First Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
OppoEPVHeatMapplot2H <- OppoEPVHeatMapData2H %>%
  ...
  #formatting
  labs(title = paste(Match_Oppo," Open Play EPV Heat Map - Second Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
EPVHeatMapplotFTW <- EPVHeatMapDataFTW %>%
  ...
  #formatting
  labs(title = paste0(Match_LFC," Open Play EPV Heat Map - By Game Period"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
OppoEPVHeatMapplotFTW <- OppoEPVHeatMapDataFTW %>%
  ...
  #formatting
  labs(title = paste(Match_Oppo," Open Play EPV Heat Map - By Game Period"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
xGSituationBar <- xGSituationBarData %>%
  ...
  #Geometrics
  geom_bar(stat = "identity", fill = Color_LFC, colour = "#454545") +
...
xGSituationBarOppo <- xGSituationBarOppoData %>%
  ...
  #Geometrics
  geom_bar(stat = "identity", fill = Color_Oppo, colour = "#454545") +
  ...
  if ((nrow(data) > 0) &&
    ...
    if (dataSource == "UnderStat") {
      ...
      if (mapType == "Home") {
        ...
        shot_name <- paste0(home_team, ShotTitle_text_Home)  
      
      } else if (mapType == "Away") {
      
        away_team <- (data$away_team[nrow(data)]) 
        shot_name <- paste0(away_team, ShotTitle_text_Away)  
...
```{r}
#|height: 110%
LFC_S_plotW <- plot_shot_AI(LFC_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = "Liverpool", teamColor = Color_LFC, text_color = Color_LFC_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "UnderStat", logo = "", wrap = "Player")
...
```{r}
#|height: 110%
OPPO_S_plotW <- plot_shot_AI(Oppo_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = OppoHA,  mapName = Match_Oppo, teamColor = Color_Oppo, text_color = Color_Oppo_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "UnderStat", wrap = "Player")
...
```{r}
#|height: 110%
LFC_S_plotWT <- plot_shot_AI(LFC_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = "Liverpool", teamColor = Color_LFC, text_color = Color_LFC_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "UnderStat", logo = "", wrap = "Time")
...
```{r}
#|height: 110%
OPPO_S_plotWT <- plot_shot_AI(Oppo_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = OppoHA,  mapName = Match_Oppo, teamColor = Color_Oppo, text_color = Color_Oppo_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "UnderStat", wrap = "Time")
