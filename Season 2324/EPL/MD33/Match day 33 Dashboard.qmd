...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 33/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 33/Viz Pack/")

#set oppo
Match_Oppo <- paste("Fulham")

#set oppo color
Color_Oppo <- paste("black")
...
MatchIdUS <- 22229 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193865 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/9dcb5084/Fulham-Liverpool-April-21-2024-Premier-League") #check

#set Game name
GameName <- paste("FFC_vs_LFC")
...
GameNamePlayers <- paste("FFC_vs_LFC_players")
