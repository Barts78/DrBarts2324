...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 38/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Matchday 38/Viz Pack/")

#set oppo
Match_Oppo <- paste("Wolverhampton Wanderers")

#set oppo color
Color_Oppo <- paste("#d99b00")
...
MatchIdUS <- 22271 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193907 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/d4823ed5/Liverpool-Wolverhampton-Wanderers-May-19-2024-Premier-League") #check

#set Game name
GameName <- paste("LFC_vs_WWFC")
...
GameNamePlayers <- paste("LFC_vs_WFC_players")
...
MCFCSeason_MC_Plot <- ggplot(MCFCpoint_probs, aes(x = total_points, y = prob)) +
  ...
  labs(title = "Manchester City Final Predicted Point Totals (1000 Sims)",
       ...
       y = "Probability %",
       caption = my_socials) +
#  scale_x_continuous(limits = c((min(MCFCcurrent_points)), (max(MCFCpoint_probs$total_points))), breaks = seq(0, (max(MCFCpoint_probs$total_points)), 1)) +
  scale_y_continuous(limits = c(0, 100), breaks = seq(0, 100, 5)) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
        panel.background = element_rect(colour = "snow", fill = "snow"),
...
AFCSeason_MC_Plot <- ggplot(AFCpoint_probs, aes(x = total_points, y = prob)) +
  ...
  labs(title = "Arsenal Final Predicted Point Totals (1000 Sims)",
       ...
       y = "Probability %",
       caption = my_socials) +
#  scale_x_continuous(limits = c((min(AFC_League_Points)), (max(AFCpoint_probs$total_points))), breaks = seq(0, (max(AFCpoint_probs$total_points)), 1)) +
  scale_y_continuous(limits = c(0, 100), breaks = seq(0, 100, 5)) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
        panel.background = element_rect(colour = "snow", fill = "snow"),
...
EPVHeatMapplotFT <- EPVHeatMapDataFT %>%
  ...
  #plot player positions
  geom_point(data = OppoAverage_PlayerFT, aes(x, y), fill = Color_Oppo, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = OppoAverage_PlayerFT, aes(x, y, label = player_shirt), color = Color_Oppo_Text, size = 2) +
    
#          scale_fill_gradientn(
#          colors = c("#FFFFF0", Color_LFC),
         # values = scales::rescale(c(0, 1)), 
          #breaks = scales::breaks_width(0.05), 
          #name = "EPV") +
...
OppoEPVHeatMapplotFT <- OppoEPVHeatMapDataFT %>%
  ...
  #plot player positions
  geom_point(data = Average_PlayerFT, aes(x, y), fill = Color_LFC, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_PlayerFT, aes(x, y, label = player_shirt), color = Color_LFC_Text, size = 2) +
