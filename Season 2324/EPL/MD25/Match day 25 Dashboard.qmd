...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Match day 25/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Match day 25/Viz Pack/")

#set oppo
Match_Oppo <- paste("Brentford")

#set oppo color
Color_Oppo <- paste("red")

#set oppo text
Color_Oppo_Text <- paste("white")

#Set LFC
Match_LFC <- paste("Liverpool")

#set Home color
Color_LFC <- paste("purple")
...
Away_Color = Color_LFC
Home_Color = Color_Oppo
...
MatchIdUS <- 22135 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193771 #check

#set Fotmob LFC / home team ID
LFCIdFotmob <- 8650 

#set Fotmob Oppo / away team ID
OppoIdFotmob <- 9937

#set fbref match page
MatchIdFbref <- paste("https://fbref.com/en/matches/ca1e26a0/Brentford-Liverpool-February-17-2024-Premier-League") #check

#set Game name
GameName <- paste("BFC_vs_LFC")

GameWeek <- paste("MD25")

#set Game name PLayers
GameNamePlayers <- paste("BFC_vs_LFC_players")
...
WavesTitle_text <- paste0(
            glue("<span style='font-family:\"Arial\";color:gray12;font-size:16px;'>Attacking Waves</span><span style='color:gray12;font-size:16px;'>(</span><span style='font-family:\"Arial Bold\";color:{Color_LFC};font-size:16px;'>Touches</span><span style='color:gray12;font-size:16px;'>,</span><span style='font-family:\"Arial Bold\";color:ivory4;font-size:16px;'>Passes</span><span style='color:gray12;font-size:16px;'>,</span><span style='font-family:\"Arial Bold\";color:green3;font-size:16px;'>Shots</span><span style='color:gray12;font-size:16px;'>)</span>"))

OppoWavesTitle_text <- paste0(
            glue("<span style='font-family:\"Arial\";color:gray12;font-size:16px;'>Attacking Waves </span><span style='color:gray12;font-size:16px;'>(</span><span style='font-family:\"Arial Bold\";color:{Color_Oppo};font-size:16px;'>Touches</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:ivory4;font-size:16px;'>Passes</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:green3;font-size:16px;'>Shots</span><span style='color:gray12;font-size:16px;'>)</span>"))

#set xg line titles 
xGlineTitle_text <- paste0(
          glue("<span style='font-family:\"Arial Bold\";color:{Color_LFC};font-size:16px;'>xG</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:{Color_LFC};font-size:16px;'>NPxG Dashed</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:ivory4;font-size:16px;'>xGOT</span><span style='color:gray12;font-size:16px;'> development</span>"))

OppoxGlineTitle_text <- paste0(
          glue("<span style='font-family:\"Arial Bold\";color:{Color_Oppo};font-size:16px;'>xG</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:{Color_Oppo};font-size:16px;'>NPxG Dashed</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:ivory4;font-size:16px;'>xGOT</span><span style='color:gray12;font-size:16px;'> development</span>"))
...
#set shot titles
ShotTitle_text_Away <- paste0(glue("<span style='font-family:\"Arial\";gray12:black;font-size:16px;'>Shot Map (</span><span style='font-family:\"Arial Bold\";color:{Away_Color};font-size:16px;'>Goal</span><span style='font-family:\"Arial\";color:gray12;font-size:16px;'> and </span><span style='font-family:\"Arial Bold\";color:#95A5A6;font-size:16px;'>No Goal</span><span style='color:gray12;font-size:16px;'>)</span>"))

ShotTitle_text_Home <- paste0(glue("<span style='font-family:\"Arial\";color:gray12;font-size:16px;'>Shot Map (</span><span style='font-family:\"Arial Bold\";color:{Home_Color};font-size:16px;'>Goal</span><span style='font-family:\"Arial\";color:gray12;font-size:16px;'> and </span><span style='font-family:\"Arial Bold\";color:#95A5A6;font-size:16px;'>No Goal</span><span style='color:gray12;font-size:16px;'>)</span>"))
...
lineupdata <- MD_logos %>%
  ...
  #replace_na(list(Sub_Off = SubC)) %>%
  #replace_na(list(Sub_On = SubC)) %>%
...
``` {r summary table, echo:FALSE, messages:FALSE, warnings:FALSE, fig.width= 12, fig.height=10, out.height=0.8, out.width=0.8}
#|height: 25%
...
xGLinePlot_Data <- dashboard_data %>%
  ...
  #scale_color_manual(values = c("TotalxG" = Color_LFC, "TotalNPxG" = Color_LFC, "TotalxGOT" = "ivory4"), guide = guide_legend()) +
...
# change data to enable shape to be defined 
  ...
  #scale_fill_paletteer_d(ColorScale_Home, 1) +
  #scale_fill_paletteer_c(ColorScale_HomeC, 1) +
  #geom_point(aes(size = xG, fill = xG, text = paste("xG: ", xG)), shape = 21, colour = "black", stroke = 0.5, alpha = 0.9) +
  #EPV Bubble
  #new_scale_fill() +
  #scale_fill_paletteer_d(ColorScale_Home, 1) +
  #scale_fill_paletteer_c(ColorScale_HomeC, 1) +
  #geom_point(aes(size = EPV, fill = EPV, text = paste("EPV: ", EPV, "\nTime Period: ", Game_Period)), shape = 23, colour = "black", stroke = 0.5, alpha = 0.5) +
  #Labels
  #new_scale_fill() +  
  #scale_fill_paletteer_d(ColorScale_Home, 1) +
  ...
  #formatting
  labs(title = paste0(Match_LFC, " xG (Circles) & EPV (Diamonds) Creation by Time Period"),
         subtitle = paste0(Match_Fixture),
         caption = My_caption,
         x = "Passes",
         y = "Shots") +
...
# change data to enable shape to be defined 
  ...
  #formatting
  labs(title = paste0(Match_Oppo, " xG (Circle) & EPV (Diamond) Creation by Time Period"),
         subtitle = paste0(Match_Fixture),
         x = "Passes",
         y = "Shots",
         caption = My_caption
...
#|height: 110%
#shot map
LFC_S_plot <- plot_shot_AI(LFC_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "UnderStat", logo = "", wrap = "")
...
```{r}
#|height: 110%
LFC_S_plotW <- plot_shot_AI(LFC_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, text_color = Color_LFC_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "UnderStat", logo = "", wrap = "Player")
...
```{r}
#|height: 110%
LFC_S_plotWT <- plot_shot_AI(LFC_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, text_color = Color_LFC_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "UnderStat", logo = "", wrap = "Time")
