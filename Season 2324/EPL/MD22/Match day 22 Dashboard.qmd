...
``` {r setup, echo:FALSE, messages:FALSE, warnings:TRUE}
...
WavesTitle_text <- paste0(
  'Attacking Waves (', 
  '<span style="color:firebrick"> **Touches** </span>',
  ',',
...
OppoWavesTitle_text <- paste0(
  'Attacking Waves (', 
  '<span style="color:blue3"> **Touches** </span>',
  ',',
  '<span style="color:white"> **Passes** </span>',
  ',',
  '<span style="color:green3"> **Shots** </span>',
...
xGlineTitle_text <- paste0(
  '(', 
  '<span style="color:firebrick"> **Xg** </span>',
  ',',
  '<span style="color:firebrick"> **NPxG Dashed** </span>',
  ',',
...
OppoxGlineTitle_text <- paste0(
  '(', 
  '<span style="color:blue3"> **Xg** </span>',
  ',',
  '<span style="color:blue3"> **NPxG Dashed** </span>',
  ',',
  '<span style="color:gray"> **xGOT** </span>',
  '), development')
...
#set oppo
Match_Oppo <- paste("Chelsea")

#set oppo color
Color_Oppo <- paste("dodgerblue4")
...
MatchIdUS <- 22113 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4193749 #check
...
MatchIdFbref <- paste("https://fbref.com/en/matches/1836d9bd/Liverpool-Chelsea-January-31-2024-Premier-League") #check

#set Game name
GameName <- paste("LFC_vs_CFC")

GameWeek <- paste("MD22")

#set Game name PLayers
GameNamePlayers <- paste("LFC_vs_CFC_players")
...
lineupdataHome <- lineupdata %>%
  ...
  cols_width(image_url ~ px(35)) %>% # 110 = 100 (height) + 10 (padding around imgs)
...
ggsave("LFC Pass Map EPV 1st Half (oppo half passes only) no logo.png", width = 2500, height = 2150, units = "px", dpi = 400)
...
#save EPV pass network
ggsave("Oppo Pass Map EPV 1st Half (oppo half passes only) no logo.png", width = 2500, height = 2150, units = "px", dpi = 400)
```
...
#save EPV pass network
ggsave("LFC Pass Map EPV 2nd Half (oppo half passes only) no logo.png", width = 2500, height = 2150, units = "px", dpi = 400)
```
...
#save EPV pass network
ggsave("Oppo Pass Map EPV 2nd Half (oppo half passes only) no logo.png", width = 2500, height = 2150, units = "px", dpi = 400)
```
...
#save EPV pass network 
ggsave("LFC Pass Map EPV 1st Sub Game (oppo half passes only) no logo.png", width = 2500, height = 2150, units = "px", dpi = 400)
...
#save EPV pass network
ggsave("Oppo Pass Map EPV 1st Sub (oppo half passes only) no logo.png", width = 2500, height = 2150, units = "px", dpi = 400)
```
...
#geometrics
  ...
  geom_bar(aes(x = expandedMinute, y = Attempted_Passes, fill = "white"), stat = "identity",  colour = "black", width = 1, position = position_nudge(x = -0.5)) +
  geom_bar(aes(x = expandedMinute, y = TotalShots, fill = "green3"), stat = "identity", colour = "black", width = 1) +
  scale_fill_identity(name = "",
                       breaks = c(Color_LFC,"white", "green3"),
...
#formatting
  ...
  labs(title = paste(Match_LFC, " Attacking Waves"),
        caption = My_caption,
         subtitle = paste0(Match_Fixture),
         x = "Match Time (Mins)",
         y = "Metric Total") +
  theme(plot.title = element_text(colour = "black", face = "bold", size = 14),
        ...
        panel.background = element_blank(),
        legend.position = "bottom", legend.background = element_rect(fill = "snow"))
touchpass_bar_plot
```
...
Oppotouchpass_bar_plot <- Oppotouchpass_bar_data %>%
  ...
  geom_bar(aes(x = expandedMinute, y = TotalShots, fill = "green3"), stat = "identity", colour = "black", width = 1) +
  scale_fill_identity(name = "",
                      breaks = c(Color_Oppo,"white", "green3"),
                      labels = c("Touches", "Passes", "Shots"),
                      guide = "legend") +
  ...
  scale_x_continuous(breaks = seq(0, 100, 15)) +
  scale_y_continuous(breaks = seq(0, 50, 5)) +
  labs(title = paste0(Match_Oppo, " Attacking Waves"),
         subtitle = paste0(Match_Fixture),
        caption = My_caption,
         x = "Match Time (Mins)",
         y = "Metric Total") +
  theme(plot.title = element_text(colour = "black", face = "bold", size = 14),
        ...
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
        legend.position = "bottom", legend.background = element_rect(fill = "snow")) #new color snow 2
...
``` {r dribbles and duels data setup}
...
LFCfiles <- list.files(path = "~/Dropbox/AI lfc data/UP Pod Prep 2324/Match day 22/viz pack/Players",
                    pattern = "*.png",
...
Player_Summary_Plot_Home <- Player_Summary_data_Home %>% 
  ...
  guides(
    fill = guide_colorsteps(
      barwidth = 20, barheight = 0.5, title.position = "top", title.hjust = 0.5)) +
  
  labs(title = paste0(Match_LFC, " Player Match Metrics"), 
       subtitle = paste0(Match_Fixture, ", Bar = Player Absolute Value, Dot = Position Average"),
              caption = My_caption
  ) +
  theme(plot.title = element_text(colour = "black", face = "bold", size = 12),
        plot.caption = element_markdown(),
        panel.background = element_rect(colour = "black", fill = "snow"),
        plot.background = element_rect(fill = "snow", color = "snow"),
        plot.subtitle = element_text(colour = "black", size = 10),
        strip.text.x = element_text(face = "bold", size = 6, colour = "white"),
        strip.background.x = element_rect(fill = Color_LFC, color = "black", linetype = "solid", linewidth = 1),
        legend.position = "top",
        ...
        axis.text.x = element_text(color = "gray12", size = 2, face = "bold", hjust = 1),  #Making the text grey to look asthetic
...
EPVPlotData <- EPVPlotData %>%
  ...
  mutate(Goal_point_Y = ifelse(str_detect(isGoal, "1"), paste0(Home_Cumalative_EPV), NA)) %>%
  mutate(Goal_point_X = as.numeric(Goal_point_X)) %>%
  mutate(Goal_point_Y = as.numeric(Goal_point_Y),
...
OppoEPVPlotData <- OppoEPVPlotData %>%
  ...
  mutate(Goal_point_X = ifelse(str_detect(isGoal, "1"), paste0(expandedMinute), NA)) %>%
  mutate(Goal_point_Y = ifelse(str_detect(isGoal, "1"), paste0(Away_Cumalative_EPV), NA)) %>%
  mutate(Goal_point_X = as.numeric(Goal_point_X)) %>%
  mutate(Goal_point_Y = as.numeric(Goal_point_Y),
