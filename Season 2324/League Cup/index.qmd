...
League Cup Games for the **2023 - 2024** Season
::::
## Browse by Match Round
...
md_dirs <- md_dirs[grepl("^LCMD\\s+\\d+$", md_dirs)]
md_dirs <- md_dirs[order(as.numeric(sub("^LCMD\\s+", "", md_dirs)))]

default_thumb <- "Images/League_cup_ball.png"

pick_md_thumb <- function(md, base_dir = ".") {

  # extract MD number (e.g. "MD 12" -> 12)
  md_num <- sub("^LCMD\\s+", "", md)

  thumb_path <- file.path(
    base_dir,
    md,
    "docs",
    paste0("LC-Match-day-", md_num, "-Dashboard_files"),
    "figure-html",
  ...
  if (file.exists(thumb_path)) {
    ...
    "Images/League_cup_ball.png"   # fallback
  }
}
