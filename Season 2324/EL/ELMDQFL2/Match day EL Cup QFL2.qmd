...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/EL Cup QFL2/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/EL Cup QFL2/Viz Pack/")

#set oppo
Match_Oppo <- paste("Atalanta")

#set oppo color
Color_Oppo <- paste("#004ca6")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/67a48203/Atalanta-Liverpool-April-18-2024-Europa-League") #check

#set Game name
GameName <- paste("AFC_vs_LFC_ELCupQFL2")

GameWeek <- paste("ELCupQFL2")

#set Game name PLayers
GameNamePlayers <- paste("AFC_vs_LFC_ELCupQFL2_players")
