...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/EL Cup R16L2/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/EL Cup R16L2/Viz Pack/")

#set oppo
Match_Oppo <- paste("Sparta Prague")

#set oppo color
Color_Oppo <- paste("#030303")

#set oppo text
Color_Oppo_Text <- paste("#FFD700")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/930d92c4/Liverpool-Sparta-Prague-March-14-2024-Europa-League") #check

#set Game name
GameName <- paste("LFC_vs_SPFC_ELCupR16L2")

GameWeek <- paste("ELCupR16L2")

#set Game name PLayers
GameNamePlayers <- paste("LFC_vs_SPFC_ELCupR16L2_players")
...
#  cols_width(Player ~ px(45)) %>% # 110 = 100 (height) + 10 (padding around imgs)
  ...
  tab_options(
    ...
    source_notes.font.size = 8,
    table.width = "100%") %>%
  gt_color_rows(columns = c(5), palette = ColorScale_Home, domain = c(0,20)) %>%
  gt_color_rows(columns = c(6, 7, 14, 15, 16, 20, 23, 26), palette = ColorScale_Home, domain = c(0,120)) %>%
  gt_color_rows(columns = c(8, 21, 25), palette = ColorScale_Home, domain = c(0,15)) %>%
  gt_color_rows(columns = c(9:11, 17:18), palette = ColorScale_Home, domain = c(0,5)) %>%
  gt_color_rows(columns = c(22, 24), palette = ColorScale_Home, domain = c(0,25)) %>%
...
#  cols_width(Player ~ px(45)) %>% # 110 = 100 (height) + 10 (padding around imgs)
  ...
  tab_options(
    ...
    source_notes.font.size = 8,
    table.width = "100%") %>%
  gt_color_rows(columns = c(5), palette = ColorScale_Away, domain = c(0,20)) %>%
  gt_color_rows(columns = c(6, 7, 14, 15, 16, 20, 23, 26), palette = ColorScale_Away, domain = c(0,120)) %>%
  gt_color_rows(columns = c(8, 21, 25), palette = ColorScale_Away, domain = c(0,15)) %>%
  gt_color_rows(columns = c(9:11, 17:18), palette = ColorScale_Away, domain = c(0,5)) %>%
  gt_color_rows(columns = c(22, 24), palette = ColorScale_Away, domain = c(0,25)) %>%
...
#  cols_width(Player ~ px(45)) %>% # 110 = 100 (height) + 10 (padding around imgs)
  ...
  gt_color_rows(columns = c(7:11, 16, 28:29), palette = ColorScale_Home, domain = c(0,80)) %>% #passes recieved and touch breakdown & carries
  gt_color_rows(columns = c(6), palette = ColorScale_Home, domain = c(0,120)) # total t
Home_player_stats
...
#  cols_width(Player ~ px(45)) %>% # 110 = 100 (height) + 10 (padding around imgs)
  ...
  gt_color_rows(columns = c(7:11, 16, 28:29), palette = ColorScale_Away, domain = c(0,80)) %>% #passes recieved and touch breakdown & carries
  gt_color_rows(columns = c(6), palette = ColorScale_Away, domain = c(0,120)) # total t
Away_player_stats
...
#|height: 110%
#shot map
LFC_S_plot <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "")
...
```{r away shot plot}
#|height: 110%
OPPO_S_plot <- plot_shot_AI(Oppodashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = OppoHA,  mapName = Match_Oppo, teamColor = Color_Oppo, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta")
...
#|height: 110%
LFC_S_plotW <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, text_color = Color_LFC_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "Player")
...
#|height: 110%
OPPO_S_plotW <- plot_shot_AI(Oppodashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = OppoHA,  mapName = Match_Oppo, teamColor = Color_Oppo, text_color = Color_Oppo_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", wrap = "Player")
...
#|height: 110%
LFC_S_plotWT <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, text_color = Color_LFC_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "Time")
...
#|height: 110%
OPPO_S_plotWT <- plot_shot_AI(Oppodashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = OppoHA,  mapName = Match_Oppo, teamColor = Color_Oppo, text_color = Color_Oppo_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", wrap = "Time")
