...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/EL Cup QFL1/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/EL Cup QFL1/Viz Pack/")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/52b91e53/Liverpool-Atalanta-April-11-2024-Europa-League") #check

#set Game name
GameName <- paste("LFC_vs_AFC_ELCupQFL1")

GameWeek <- paste("ELCupQFL1")

#set Game name PLayers
GameNamePlayers <- paste("LFC_vs_AFC_ELCupQFL1_players")
