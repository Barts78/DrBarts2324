...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/EL Cup R16L1/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/EL Cup R16L1/Viz Pack/")

#set oppo
Match_Oppo <- paste("Sparta Prague")

#set oppo color
Color_Oppo <- paste("#8E192B")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/eda83a1d/Sparta-Prague-Liverpool-March-7-2024-Europa-League") #check

#set Game name
GameName <- paste("SPFC_vs_LFC_ELCupR16L1")

GameWeek <- paste("ELCupR16L1")

#set Game name PLayers
GameNamePlayers <- paste("SPFC_vs_LFC_ELCupR16L1_players")
...
#load shot data from Fotmob
LFC_shotsUS <- EPL_FotMob_shots_EPL2324

# home shot data
LFC_shotsUS <- LFC_shotsUS %>%
  filter(team_id == LFCIdFotmob)

colnames(LFC_shotsUS)[colnames(LFC_shotsUS) == "type"] <- "result"

# away shot data
Oppo_shotsUS <- EPL_FotMob_shots_EPL2324

#Shot plot team match
Oppo_shotsUS <- Oppo_shotsUS %>%
  filter(team_id == OppoIdFotmob)
colnames(Oppo_shotsUS)[colnames(Oppo_shotsUS) == "type"] <- "result"
...
LFCpassPlotWrapWD <- plot_passnet_AI(data = plottingData,  
                                     ...
                                     plot_start = 00, plot_finish = 130, wrap = "Yes", pressmap = "Yes", passes = 2)
LFCpassPlotWrapWD
```
...
ggsave(path = Vizlocation, "LFC Pass Map EPV 1st Half (oppo half passes only).png", width = 2500, height = 2150, units = "px", dpi = 400)
...
#save EPV pass network
ggsave(path = Vizlocation, "Oppo Pass Map EPV 1st Half (oppo half passes only).png", width = 2500, height = 2150, units = "px", dpi = 400)
```
...
#save EPV pass network
ggsave(path = Vizlocation, "LFC Pass Map EPV 2nd Half (oppo half passes only).png", width = 2500, height = 2150, units = "px", dpi = 400)
```
...
#save EPV pass network
ggsave(path = Vizlocation, "Oppo Pass Map EPV 2nd Half (oppo half passes only).png", width = 2500, height = 2150, units = "px", dpi = 400)
```

### Row 7

```{r home passnet att 1st sub}
...
#save EPV pass network 
ggsave(path = Vizlocation, "LFC Pass Map EPV 1st Sub Game (oppo half passes only).png", width = 2500, height = 2150, units = "px", dpi = 400)
```

```{r away passnet att 1st sub}
...
#save EPV pass network
ggsave(path = Vizlocation, "Oppo Pass Map EPV 1st Sub (oppo half passes only).png", width = 2500, height = 2150, units = "px", dpi = 400)
```

### Row 8
```{r home passnet wrap att}
LFCpassPlotFTAttW <- plot_passnet_AI(data = plottingData,  
                                      ...
                                      plot_start = 00, plot_finish = 130, pitch = "Half", pressmap = "Yes", wrap = "Yes", passes = 2)
LFCpassPlotFTAttW
```

```{r away passnet wrap att}
...
### Row 9
```{r home passnet extra time}
#pass map EPV LFC 1st half
LFCpassNetET <- plot_passnet_AI(data = plottingData, team_name = Match_LFC, scale_stat = "EPV", scale_color = Color_LFC, text_color = Color_LFC_Text, subtitle = paste0(Match_Fixture, " Extra Time"), plot_start = 91, plot_finish = 125, pressmap = "Yes", passes = 4)
#LFCpassNetET

```

```{r away passnet extra time}
#pass map EPV Oppo 1st half
OppopassNetET <- plot_passnet_AI(data = plottingData, team_name = Match_Oppo, scale_stat = "EPV", scale_color = Color_Oppo, text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture, " Extra Time"), plot_start = 91, plot_finish = 125, pressmap = "Yes", passes = 4)
#OppopassNetET

```

### Row 10
```{r home pass att extra time}
#pass map EPV LFC 1st half
LFCpassPlotAttET <- plot_passnet_AI(data = plottingData, 
                                  team_name = Match_LFC, scale_stat = "EPV", 
                                  scale_color = Color_LFC, text_color = Color_LFC_Text, subtitle = paste0(Match_Fixture, " Extra Time"), plot_start = 91, plot_finish = 130, pitch = "Half", pressmap = "Yes", passes = 4)

#LFCpassPlotAttET

```

```{r away pass att extra time}
#pass map EPV Oppo 1st half
OppopassPlotAttET <- plot_passnet_AI(data = plottingData, 
                                     team_name = Match_Oppo, scale_stat = "EPV", 
                                     scale_color = Color_Oppo, text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture, " Extra Time"), plot_start = 91, plot_finish = 130, pitch = "Half", pressmap = "Yes", passes = 4)
#OppopassPlotAttET
...
#geometrics
  ...
  #geom_text(aes(x = 45, y = 0, label = "HT"), colour = "black", hjust = -1.5, vjust = 1, size = 4) +
...
Player_Summary_Plot_Away <- Player_Summary_data_Away %>% 
  ...
  guides(fill = guide_colorsteps(
      barwidth = 20, barheight = .25, title.position = "top", title.hjust = .5, title.theme = element_text(size = 4, colour = "black"))) +
...
## Row 1 {height = 110%}
```{r home overall shot map}
#|height: 110%
#shot map
LFC_S_plot <- plot_shot_AI(LFC_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "FotMob", logo = "", wrap = "")
...
```{r away overal shot map}
#|height: 110%
OPPO_S_plot <- plot_shot_AI(Oppo_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = OppoHA,  mapName = Match_Oppo, teamColor = Color_Oppo, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "FotMob")
...
## Row 2  {height = 110%}
```{r home shot map player}
#|height: 110%
LFC_S_plotW <- plot_shot_AI(LFC_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, text_color = Color_LFC_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "FotMob", logo = "", wrap = "Player")
...
```{r away shot map player}
#|height: 110%
OPPO_S_plotW <- plot_shot_AI(Oppo_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = OppoHA,  mapName = Match_Oppo, teamColor = Color_Oppo, text_color = Color_Oppo_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "FotMob", wrap = "Player")
...
## Row 3 {height = 110%}
```{r home shot map time}
#|height: 110%
LFC_S_plotWT <- plot_shot_AI(LFC_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = LFCHA, mapName = Match_LFC, teamColor = Color_LFC, text_color = Color_LFC_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "FotMob", logo = "", wrap = "Time")
...
```{r away shot map time}
#|height: 110%
OPPO_S_plotWT <- plot_shot_AI(Oppo_shotsUS, highlight_goals = TRUE, average_location = FALSE, mapType = OppoHA,  mapName = Match_Oppo, teamColor = Color_Oppo, text_color = Color_Oppo_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "FotMob", wrap = "Time")
